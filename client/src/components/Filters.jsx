...
export default function Filters({ searchTrails, setFilteredSearchTrails, filteredSearchTrails }) {
    ...
    useEffect(() => {
        ...
        switch (filters.sortBy) {
          ...
          case 'hardestToEasiest':
            ...
            break
          case 'mostReviewed':
            sortedArray = filteredArray.sort((a, b) => b.reviews.length - a.reviews.length)
            break
          default:
